...
public class IamRoleRestImpl implements IamRoleRest {
    private IamRoleRepository iamRoleRepository = new IamRoleRepository();

    @Override
    public List<IamRole> getAllRoles() {
        return this.iamRoleRepository.findAll();
    }
