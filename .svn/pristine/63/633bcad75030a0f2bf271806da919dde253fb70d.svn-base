...
@Path(value = "/group-contexts")
public interface IamContextGroupRest {
    ...
    @GET
    List<IamContextGroup> getAllContextGroups();
    ...
    @Produces("application/json")
    @POST
    IamContextGroup postContextGroup(IamContextGroup iamContextGroup);
    ...
    @Produces("application/json")
    @PUT
    IamContextGroup putContextGroup(IamContextGroup iamContextGroup);
    ...
    @Produces("application/json")
    @DELETE
    void deleteContextGroup(@PathParam(value = "contextId") String contextId);
