...
public class PropertiesWatcher {
    ...
    public void init() throws IOException {
        ...
        properties.put("service.pid", "com.idfor.kat.tools.katjobmanager");
        propertiesService = bundleContext.registerService(ManagedService.class.getName(), new KatJobManagerProperties(), properties);
        ...
        if (serviceReference != null) {
            ...
            if (configurationAdmin != null) {
                Configuration configuration = configurationAdmin.getConfiguration("com.idfor.kat.tools.katjobmanager");
                if(configuration != null) {
                    properties = configuration.getProperties();
                    KatJobManagerProperties.update(properties);
                }
                else LOGGER.error("Config file com.idfor.kat.tools.katjobmanager has not been found !");
            }
        }
    }
